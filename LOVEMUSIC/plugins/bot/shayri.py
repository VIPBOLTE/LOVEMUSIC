...
# Function to get a random picture URL
...
async def shayari_with_picture(client: Client, message: Message):
    shayari_text = random.choice(SHAYRI)
    picture_url = get_random_picture()
...
async def shayari_with_picture_private(client: Client, message: Message):
    shayari_text = random.choice(SHAYRI)
    picture_url = get_random_picture()
